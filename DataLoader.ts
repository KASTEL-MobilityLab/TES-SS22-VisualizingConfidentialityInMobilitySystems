 ...
 * */
 export function getCompanyData(cId: String) {
    var dataArray = [companiesJson[getPosFromId(cId)].name]
    return(dataArray);
}
 ...
 * */
 export function getPaymentData(pId: String) {
    var dataArray = [paymentsJson[getPosFromId(pId)].tripId, paymentsJson[getPosFromId(pId)].type, 
    paymentsJson[getPosFromId(pId)].provider, paymentsJson[getPosFromId(pId)].cardNumber, 
    paymentsJson[getPosFromId(pId)].ccv, paymentsJson[getPosFromId(pId)].expiryDate];
    return(dataArray);
}
 ...
 * */
 export function getRouteData(rId: String) {
    var dataArray = [routesJson[getPosFromId(rId)].start.lat, routesJson[getPosFromId(rId)].start.lng, 
    routesJson[getPosFromId(rId)].end.lat, routesJson[getPosFromId(rId)].end.lng];
    return(dataArray);
}
 ...
 * */
 export function getTripData(tId: String) {
    var dataArray = [tripsJson[getPosFromId(tId)].routeId, tripsJson[getPosFromId(tId)].vehicleId, 
    tripsJson[getPosFromId(tId)].userId, tripsJson[getPosFromId(tId)].paymentId, 
    tripsJson[getPosFromId(tId)].avgSpeed, tripsJson[getPosFromId(tId)].price,
    tripsJson[getPosFromId(tId)].startTime, tripsJson[getPosFromId(tId)].endTime];
    return(dataArray);
}
 ...
 * */
 export function getUserData(uId: String) {
    var dataArray = [usersJson[getPosFromId(uId)].forename, usersJson[getPosFromId(uId)].surname, 
    usersJson[getPosFromId(uId)].phoneNumber, usersJson[getPosFromId(uId)].email];
    return(dataArray);
}
 ...
 * */
 export function getVehicleData(vId: String) {
    var dataArray = [vehiclesJson[getPosFromId(vId)].type, vehiclesJson[getPosFromId(vId)].companyId,
    vehiclesJson[getPosFromId(vId)].condition, vehiclesJson[getPosFromId(vId)].batteryCondition, 
    vehiclesJson[getPosFromId(vId)].status, vehiclesJson[getPosFromId(vId)].batteryLevel];
    return(dataArray);
}

export function getPosFromId(id: String) {
    var posString = id.substring(1,10);
